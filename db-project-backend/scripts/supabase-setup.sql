...
-- Version: 2.0 (Updated to match Sequelize models)
...
-- Create ENUM types first (before they're referenced)
...
-- User table (matches Sequelize model)
...
-- CrimeSubmission table (simplified to match Sequelize model)
